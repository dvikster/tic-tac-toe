...
var PageTransitions = (function () {
    ...
    function init() {
        ...
        $('.pt-trigger.main-menu').click(function() {
            $('.pt-trigger.main-menu').removeClass('current-menu');
            $pageTrigger = $(this);
            Animate($pageTrigger);
            $pageTrigger.addClass('current-menu');
        });
        $('.pt-trigger.sub-menu.about').click(function() {
            $('.pt-trigger.sub-menu.about').removeClass('current-menu');
            $pageTrigger = $(this);
            Animate($pageTrigger);
            $pageTrigger.addClass('current-menu');
        });
        $('.pt-trigger.sub-menu.skills').click(function() {
            $('.pt-trigger.sub-menu.skills').removeClass('current-menu');
            $pageTrigger = $(this);
            Animate($pageTrigger);
            $pageTrigger.addClass('current-menu');
        });
        $('.pt-trigger.sub-menu.portfolio').click(function() {
            $('.pt-trigger.sub-menu.portfolio').removeClass('current-menu');
            $pageTrigger = $(this);
            Animate($pageTrigger);
            $pageTrigger.addClass('current-menu');
        });
        $('.pt-trigger.sub-menu.contact').click(function() {
            $('.pt-trigger.sub-menu.contact').removeClass('current-menu');
            $pageTrigger = $(this);
            Animate($pageTrigger);
            $pageTrigger.addClass('current-menu');
        });
